...
public class MainActivity extends AppCompatActivity implements GetterId, ConnectCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setName.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!name.isEmpty()) {
                    SuperUser.name = name;
                   new SocketConnecter(MainActivity.this);
    ...
    public void connectionFailed() {
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            @Override
            public void run() {
                Toast error = Toast.makeText(MainActivity.this, "Server unavaliable", Toast.LENGTH_LONG);
                error.show();
            }
        });
    }
